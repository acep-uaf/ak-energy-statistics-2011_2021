...
long_price <- p_price %>%
  ...
  mutate(Customers = ifelse(Sector == "Industrial", `Industrial Customers`, Customers)) %>%
...
viz %>%  
  ...
  labs(title = "Avg Price of Electricity, 2011-2021",
...
viz %>%  
  ...
  labs(title = "Weighted Population, Price of Electricity, 2011-2021",
       subtitle = paste(plot_region, " Region",sep = ""),
...
price %>%
  ...
  ggplot( aes(x=`ACEP Energy Region`, y=log(residential_weighted_price), fill=`ACEP Energy Region`)) +
