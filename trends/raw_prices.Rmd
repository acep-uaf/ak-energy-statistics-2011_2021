...
# Customers Clean
2019 "SR-10" has a "." value, causing column to read as character
NOTE: column `Residential Sales MWh` has awful \n character (excel artifact)
      code must be run exactly like below, otherwise won't recognize
```{R}
rev2019$`Residential Sales
 MWh` <- sub(".", "0", rev2019$`Residential Sales
 MWh`)

rev2019$`Residential Customers` <- sub(".", "0", rev2019$`Residential Customers`)
