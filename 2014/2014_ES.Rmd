...
drive <- "~/Desktop"
setwd(drive)
workbook <- "~/Desktop/workbooks/2014 AK Energy Statistics early release.xlsx"
...
# table 2.4a
Net Generation, Fuel Type, Emissions, Efficiency by Operators/Utilities, 2014"
...
## table 2.5a
### "Table 2.5a Revenue, Sales and Customers by Customer Type by Operators/Utilities ($000, MWh, Accounts), 2014"
```{R}
...
## table 2.5b
### "Table 2.5b  Average Annual Energy Use and Rates by Customer Type by Operators/Utilities, (kWh/Customer, $/Customer, $/kWh), 2014"
```{R}
...
## table 2.5c
### "Table 2.5c  Average Residential Rates and PCE Payments ($/kWh), 2014"
```{R}
# save title
