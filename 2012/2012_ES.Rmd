...
drive <- "~/Desktop"
setwd(drive)
workbook <- "~/Desktop/workbooks/2012 AK Energy Statistics.xlsx"
...
save_raw <- "~/repos/ak-energy-statistics-2011_2021/2012/raw/"
setwd(save_raw)
...
**VERY IMPORTANT**
```{R}
save_staging <- "~/repos/ak-energy-statistics-2011_2021/2012/staging/"
setwd(save_staging)
...
# watch out! different than others
colnames(`Table 2.4a`) <- `Table 2.4a`[1, ]

# delete extra rows
`Table 2.4a` <- `Table 2.4a`[-c(1), ]
...
## table 2.5a
### "Table 2.5a Revenue, Sales and Customers by Customer Type by Operators/Utilities ($000, MWh, Accounts), 2012"
```{R}
...
## table 2.5b
### "Table 2.5b  Average Annual Energy Use and Rates by Customer Type by Operators/Utilities, (kWh/Customer, $/Customer, $/kWh), 2012"
```{R}
...
## table 2.5c
### "Table 2.5c  Average Residential Rates and PCE Payments ($/kWh), 2012"
```{R}
# save title
