...
drive <- "~/Desktop"
setwd(drive)
workbook <- "~/Desktop/workbooks/2015 AK Energy Statistics early release.xlsx"
...
save_raw <- "~/repos/ak-energy-statistics-2011_2021/2015/raw/"
setwd(save_raw)
...
**VERY IMPORTANT**
```{R}
save_staging <- "~/repos/ak-energy-statistics-2011_2021/2015/staging/"
setwd(save_staging)
...
## table 2.4a
"Net Generation, Fuel Type, Emissions, Efficiency by Operators/Utilities, 2015"
...
if(`Table 2.5a`[1,1] == "Table 2.5a Revenue, Sales and Customers by Customer Type by Operators/Utilities ($000, MWh, Accounts), 2015") {
...
if(`Table 2.5b`[1,1] == "Table 2.5b  Average Annual Energy Use and Rates by Customer Type by Operators/Utilities, (kWh/Customer, $/Customer, $/kWh), 2015"){
  # save second row as column names
...
if(`Table 2.5c`[1,1] == "Table 2.5c  Average Residential Rates and PCE Payments ($/kWh), 2015"){
